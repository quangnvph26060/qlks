...
function initViewScript() {
    $(document).off("click", ".room-booking").on("click", ".room-booking", function () {
...
function initViewScript1() {
    ...
    $(document).off("click", ".check_in_data").on("click", ".check_in_data", function () {
        let dataId = $(this).attr("data-booking-id");
        let Id = $(this).attr("data-id");
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.status == 'success') {
                    ...
                    console.log(selected_customer_source);
