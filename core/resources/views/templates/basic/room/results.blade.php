        ...
        <div class="card p-3 room-item" style="max-width: 100%;">
            <div class="row g-0">
                <div class="col-custom-md-4 col-sm-5 col-custom-ssm-5 col-custom-sssm-5 position-relative">
                    <img src="{{ \Storage::url($room->main_image) }}" class="responsive-image rounded" alt="Hotel Image">
                    ...
                    <div class="card-body  py-1">
                        ...
                        <div class="border-start d-flex flex-column justify-content-center d-lg-custom-none">
                            ...
                            <a class="btn btn-sm btn--base"
                                href="{{ route('room.type.details', $room->roomType->slug) }}">
    ...
    <div class="col-md-9">
        <div class="card custom--card border-0">
            <div class="card-body text-center empty-message">
                ...
                <h5 class="mt-3">{{ __('Không có phòng nào') }}</h5>
                <span class="text--muted mt-2">{{ __($emptyMessage) }}</span>
            </div>
        </div>
    </div>
@endif
