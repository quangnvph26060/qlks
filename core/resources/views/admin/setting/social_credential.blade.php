                                        ...
                                        <td>
                                            <div class="button--group">
                                                @can('admin.setting.socialite.credentials.update')
                                                    <button class="btn btn-outline--primary btn-sm editBtn" data-client_id="{{ $credential->client_id }}" data-client_secret="{{ $credential->client_secret }}" data-key="{{ $key }}"><i class="la la-cogs"></i>
                                                        @lang('Configure')
                                                    </button>
                                                @endcan
