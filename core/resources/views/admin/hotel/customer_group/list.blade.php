...
@section('panel')
    <div class="row">
        <div class="col-12">
                ...
                <div class="modal-dialog" id="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="addGroup" action="{{ route('admin.hotel.customer.group.store') }}" method="POST">
                                @csrf
                                <!-- Input 1 -->
                                <div class="mb-3">
            ...
            <div class="modal fade" id="edit-customer-group" data-bs-backdrop="static" data-bs-keyboard="false"
            ...
            $('.btn-edit-group').on('click', function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#editGroup').attr('action',
                            '{{ route('admin.hotel.customer.group.update', '') }}/' +
                            dataId + '')
                    },
