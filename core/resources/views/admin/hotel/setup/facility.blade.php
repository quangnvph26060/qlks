            ...
            <div class="card-body">
                ...
                <div class="col-md-12 col-sm-12 d-flex">
                        ...
                        <button class="btn btn--primary" data-modal_title="Làm mới">
                         ...
                         <a>
                            <button class="btn btn--primary"  data-modal_title="Thêm mới cơ sở vật chất"  type="button" id="btn-add-status"
                                    data-bs-toggle="modal" data-bs-target="#status-code"  style="margin-left:10px">
                                <i class="las la-plus  p-1"></i>
                            </button>
                        </a>
                            <form role="form" enctype="multipart/form-data" action="{{route('admin.hotel.setup.facilities.search')}}">
        ...
        $(document).ready(function() {
            ...
            $('#btn-add-status').on('click', function() {
                ...
                row += `
                        ...
                        <!-- Input 2 -->
                        <div class="mb-3">
                            <label for="statusName" class="form-label">Tiêu đề cơ sở vật chất</label>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.status === 'success') {
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Chỉnh sửa cơ sở vật chất
                                    </h1>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form id="btn-submit-status-update" action="{{ route('admin.hotel.setup.facilities.update', '') }}/${data.data['id']}"
                                        method="POST">
                                        @csrf
                            <!-- Input 1 -->
                            <div class="mb-3">
