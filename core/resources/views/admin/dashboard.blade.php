...
@section('panel')
    <div class="row gy-4">
        ...
        <div class="col-xxl-3 col-sm-6">
            <x-widget color="info" icon="la la-sign-in" link="admin.upcoming.booking.checkin" style="2" cover_cursor="1" overlay_icon="0" title="Đăng ký sắp tới" value="{{ $widget['upcoming_checkin'] }}" />
        </div>
        ...
        <div class="col-xxl-3 col-sm-6">
            <x-widget color="success" icon="la la-clipboard-check" icon_style="false" link="admin.booking.active" style="2" cover_cursor="1" overlay_icon="0" title="Đặt chỗ đang hoạt động" value="{{ $widget['active'] }}" />
        </div>

        <div class="col-xxl-3 col-sm-6">
            <x-widget color="primary" icon="la la-city" icon_style="false" link="admin.booking.all" style="2" cover_cursor="1" overlay_icon="0" title="Tổng số đặt phòng" value="{{ $widget['total'] }}" />
        </div>
    </div>
