                                    ...
                                    <div class="selected-product d-flex justify-content-between align-items-center mb-2 py-2 border-bottom"
                                        ...
                                        <div class="quantity d-flex align-items-center me-3 flex-shrink-0"
                                            ...
                                            <input type="text" class="form-control mx-2 handled-focus-edit money-input"
                                                ...
                                                min="1" max="{{ $item->product['stock'] }}" style="width: 117px; text-align: center; height: 30px;">
                                            {{-- <button type="button"
                                        ...
                                        <select name="warehouses_to[{{ $item->product_id }}]" id="warehouses_to"
                                            ...
                                            @foreach ($warehouses as $k)
                                                <option value="{{ $k->id }}"
                                                    {{ $k->id == $warehouse->from_warehouse_id ? 'selected' : '' }}>
                                                    {{ $k->name }}</option>
                                            @endforeach
                                        ...
                                        <select name="warehouses_from[{{ $item->product_id }}]" id="warehouses_from"
                                            ...
                                            @foreach ($warehouses as $k)
                                                <option value="{{ $k->id }}"
                                                    {{ $k->id == $warehouse->to_warehouse_id ? 'selected' : '' }}>
                                                    {{ $k->name }}</option>
                                            @endforeach
