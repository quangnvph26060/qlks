            ...
            <div class="login-right">
                ...
                <form action="{{ route('admin.login') }}" method="POST" class="login-form">
                    ...
                    <div class="form-group position-relative">
                        ...
                        <input id="passwordInput" type="password" class="form-control pr-5" name="password" required />
                        <span id="togglePassword"
                            style="position: absolute; top: 44px; right: 15px; cursor: pointer; user-select: none;"
