                        ...
                        <div class="row">
                            ...
                            <div class="row-box col-12">
                                <div class="box">
                                    ...
                                    <input type="date"  id="price_validity_period" class="form-control " name="price_validity_period" >
                                    <span class="invalid-feedback d-block" style="font-weight: 500"
                            ...
                            <div class="row-box col-4">
                                <div class="box">
                                    ...
                                    <input type="text"  id="unit_price" class="form-control money-input" name="unit_price" placeholder="Đơn giá">
                                    <span class="invalid-feedback d-block" style="font-weight: 500"
                            ...
                            <div class="row-box col-4">
                                <div class="box">
                                    ...
                                    <input type="text" name="overtime" id="overtime" class="form-control money-input" placeholder="Quá giờ">
                                    <span class="invalid-feedback d-block" style="font-weight: 500"
                            ...
                            <div class="row-box col-4">
                                <div class="box">
                                    ...
                                    <input type="text" name="too_many_people" id="too_many_people" class="form-control money-input" placeholder="Quá người">
                                    <span class="invalid-feedback d-block" style="font-weight: 500"
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.status === 'success') {
                                ...
                                $('#too_many_people').val(formatCurrencyNoVND(data.extra_person_price));
