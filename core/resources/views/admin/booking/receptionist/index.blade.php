                        ...
                        <form id="bookingForm" action="" class="booking-form-pttt" method="POST">
                                    ...
                                    <div class="col-12 col-md-6">
                                                ...
                                                <div class="d-flex">
                                                    <div class="col-md-8">
                                                        <input type="text" style="height: 35px" name="name"
                                                            id="name_edit" class="form-control name-edit"
                                        ...
                                        <div class="md-3 d-flex flex-column mt-1 mb-3">
                                            ...
                                            <div class="col-md-8 d-flex align-items-center result-add-customer"
                                                style="gap:10px">
                                                <input type="checkbox" style="width: 15px !important;"
                            ...
                            <div class="row">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <p class="delete-room-booking-edit-letan  d-flex align-items-center"
                                ...
                                <div class="table-scroll-wrapper">
                                    <div class="table-responsive mt-1 table-responsive--md ">
                                        <table class=" table--light table table-bordered text-center" id="data-table">
                                            ...
                                            <tbody id="list-booking-edit-letan" class="list-booking-scroll">
                                                <!-- Nội dung động -->
                                            </tbody>
