...
<div class="modal fade" id="myModal-booking-edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel-booking"
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document" style="width: 100%;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title pageModal" id="myModalLabel-booking">Sửa đặt phòng</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body "
                style="padding: 5px 12px 12px 5px; overflow-x: auto; scrollbar-width: none; -ms-overflow-style: none; margin-bottom: 20px;">


                <form id="bookingForm" action="{{ route('admin.room.book.edit') }}" class="booking-form-edit"
                    method="POST">
                    @csrf
                    <div class="row">
                                ...
                                <div class="d-flex flex-column custom-gap-lg">
                                    ...
                                    <div class="customer-input-container" style="height: 77px">
                                        <div class="col-md-1 mb-1" style="margin-left: 2px">
                                            ...
                                            <p class="btn btn--primary modal--search-customer"
                                                style="white-space: nowrap; font-size: 13px;height: 35px;"
                                                id="btn-search">Tìm
                                                khách</p>
                                        </div>
                                        ...
                                        <div>
                                            <div class="col-md-8">
                                                <input type="text" name="name" style="height: 35px" id="name_edit"
                                    ...
                                    <div class="col-md-8 " style="height: 39px">
                                        ...
                                        <span class="invalid-feedback d-block"
                                            style="font-weight: 500"id="phone_edit_error"></span>
                                    </div>
                                    ...
                                    <div class="col-md-8 mb-3 mt-3 d-flex align-items-center result-add-customer"
                                        style="gap:10px">
                                        <input type="checkbox" style="width: 15px !important;" name="insert_customer">
                            ...
                            <div class="col-md-6">
                                <div class="d-flex flex-column custom-gap-lg">
                                    ...
                                    <div class="col-md-8 mt-1">
                                        ...
                                        <div class="d-flex align-items-center justify-content-start"
                                            style="gap: 10px">
                                            <select id="select-staff-edit"name="name_staff" class="form-control "
                                    ...
                                    <div class="col-md-8 mt-1 ">
                                        ...
                                        <select id="select-customer-source-edit" name="customer_source"
                    ...
                    <div class="row">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <p class="delete-room-booking-edit d-flex align-items-center"
                        ...
                        <div class="table-scroll-wrapper">
                            <div class="table-responsive mt-1 table-responsive--md ">
                                <table class="table table--light table-bordered text-center" id="data-table">
                                    ...
                                    <tbody id="list-booking-edit" class="list-booking-scroll">
                                        <!-- Nội dung động -->
                                    </tbody>
                        ...
                        <div class="d-flex justify-content-end" style="gap: 10px;">
                            <p type="button" data-method="check_in"
                                data-url="{{ route('admin.room.booked.check.in') }}"
                                class="btn btn-success btn-check-in-room">Nhận phòng</p>
                            <button type="button" data-row="booked"
                                class="btn-dat-truoc btn-book-edit ">Lưu</button>
