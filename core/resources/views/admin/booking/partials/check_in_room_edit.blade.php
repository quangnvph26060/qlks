...
<div class="modal fade" id="myModal-check-in-edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel-booking"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document" style="width: 100%;">
        <div class="modal-content">
            ...
            <div class="modal-body " style="padding: 5px 5px 12px 15px; overflow-x: auto; scrollbar-width: none; -ms-overflow-style: none;">


                <form id="bookingForm" action="{{ route('admin.check.in.update') }}" class="booking-form-edit" method="POST">
                    @csrf
                    <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="d-flex flex-column custom-gapl-lg">
                                    ...
                                    <div class="customer-input-container">
                                          <div class="d-flex mb-1" style="gap:10px">
                                            ...
                                            <p class="btn btn--primary modal--search-customer"
                                                style="white-space: nowrap; font-size: 13px;height: 35px;" id="btn-search">Tìm
                                                khách</p>
                                        </div>
                                        ...
                                        <div class="d-flex">
                                            <div class="col-md-8">
                                                <input type="text" name="name" style="height: 35px" id="name_edit" class="form-control name-edit"
                                                    placeholder="Tên khách hàng">
                                                <span class="invalid-feedback d-block name_error_edit"
                                                    style="font-weight: 500" id="name_error_edit"></span>
                                            </div>
                                            <input type="hidden" name="id_room_booking" id="id_room_booking" class="form-control id_room_booking">
                                        </div>
                                    ...
                                    <div class="col-md-8 d-flex align-items-center result-add-customer" style="gap:10px">
                                        <input type="checkbox" name="insert_customer"style="width: 15px !important;"> <p style="font-size: 13px">Lưu thông tin khách</p>
                                    </div>
                                    <div class="">
                                        <p class="add-room-booking-edit" style="width: 185px;height: 35px;">
                               ...
                               <div class="d-flex flex-column custom-gap-lg" >
                                        ...
                                        <div class="d-flex">
                                            <div class="col-md-8">
                                                <div class="d-flex align-items-center justify-content-start" style="gap: 10px">
                                                    <input type="date" name="checkInDate" id="date-book-room-booking-edit"  style="height: 35px" class="form-control " >
                                                    <input type="time" name="checkInTime" id="time-book-room-booking"  style="height: 35px" class="form-control " >
                                                </div>
                                                {{-- <span class="invalid-feedback d-block"
                                    ...
                                    <div class="col-md-8 mt-1">
                                        ...
                                        <div class="d-flex align-items-center justify-content-start"
                                            style="gap: 10px">
                                            <select id="select-staff-edit"name="name_staff"class="form-control "  style="width: 100%;height: 35px;">
                    ...
                    <div class="row">
                        ...
                        <p class="delete-room-booking-edit d-flex align-items-center" style="width: 126px;height: 35px;">
